	...
	function checkDate() {
		...
		xmlhttp.onreadystatechange = function(){
			if(xmlhttp.readyState==4 && xmlhttp.status==200){
				...
				alert("오늘 일정이 없습니다.");
				window.location.href = "/shape/wish/myWishList.do";
			}
		};
...
<!-- 					<div class="row mt-5">
					...
					<c:if test="${!empty relatedWishList}">
						<div class="row mt-5">
							<div class="col">
						...
						<div class="row">
							<div class="col">
								<div class="col text-center">
						  			<img class="shadow-sm" src="/shape/resources/dumy2.jpg" width="831px" style="border-radius: 5px/5px">
								</div>
							</div>
						</div>
					</c:if>
					<c:if test="${!empty relatedWishList}">
						<div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
							<div class="carousel-inner">
								<c:forEach items="${relatedWishList}" var="data" varStatus="status">
									<c:choose>
								  		...
								  		<div class="card shadow-sm px-5 py-2">
								  			<div class="card-body  px-5">
												...
												<div class="row mt-3">
													...
													<div class="col">
														<form action="/shape/wish/quitWishRunProcess.do">
															<input type="hidden" name="wish_run_no" value="${data.wishRunVo.no }">
															<input class="shadow-sm btn btn-secondary form-control" type="submit" value="위시 포기하기">
														</form>
													</div>
													<div class="col-2"></div>
												</div>
